export default function Hero() {
    return (
        <div className="relative h-[80vh] md:h-[60vh] w-full bg-gradient-to-br from-[#2f5495] via-[#2f5495] to-purple-700 overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                ...
                <p className="text-white mt-4 max-w-3xl text-base md:text-lg">
